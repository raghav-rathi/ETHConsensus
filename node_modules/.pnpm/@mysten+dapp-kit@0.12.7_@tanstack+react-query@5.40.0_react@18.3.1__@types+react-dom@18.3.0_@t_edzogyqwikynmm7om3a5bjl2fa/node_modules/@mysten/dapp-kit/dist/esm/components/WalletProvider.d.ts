...
export declare function WalletProvider({ preferredWallets, requiredFeatures, storage, storageKey, enableUnsafeBurner, autoConnect, zkSend, theme, children, }: WalletProviderProps): import("react/jsx-runtime").JSX.Element;
