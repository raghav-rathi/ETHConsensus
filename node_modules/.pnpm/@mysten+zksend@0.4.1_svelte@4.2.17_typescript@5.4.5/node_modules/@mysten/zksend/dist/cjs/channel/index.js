...
__export(channel_exports, {
  ...
  ZkSendPopup: () => ZkSendPopup,
  ZkSendRequest: () => import_events.ZkSendRequest,
  ZkSendResponse: () => import_events.ZkSendResponse
});
...
class ZkSendPopup {
  ...
  async createRequest(request) {
    ...
    const listener = (event) => {
      ...
      const { success, output } = (0, import_valibot.safeParse)(import_events.ZkSendResponse, event.data);
...
const _ZkSendHost = class {
  ...
  static fromUrl(url = window.location.href) {
    ...
    const request = (0, import_valibot.parse)(import_events.ZkSendRequest, {
    ...
    return new _ZkSendHost(request);
  }
  getRequestData() {
